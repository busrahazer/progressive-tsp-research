...
# Objective: Practice graph abstraction, random instance generation, simple heuristics, and visualization.
# • Generate random points in a 2D area and represent them as a graph using networkx.
# • Implement at least one simple TSP heuristic (Nearest Neighbor or Greedy Insertion).
# • Visualize the generated points and the tour (matplotlib or networkx draw).
# • Submit: Python script, generated graph screenshot, short explanation of the heuristic.
# ==============================
