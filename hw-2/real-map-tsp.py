...
# Objective: Move from synthetic data to real-world geography.
# • Use osmnx to download a real street network (e.g., a city region).
# • Pick a set of locations on the map as TSP nodes.
# • Solve using your heuristic from Assignment 1.
# • Visualize the tour on a real map using leaflet, folium, or similar.
# • Submit: Script + map visualization screenshot or hosted HTML.
# ==============================
